    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <form method="POST" action="<?=site_url('login/send_email'); ?>">
                    <div class="login-form-head">
                        <h4>Forgot Password</h4>
                        <p>Silahkan masukkan email anda yang telah terdaftar!</p>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit">Verify <i class="ti-arrow-right"></i></button>
                            <br>
                        </div>
						<div class="submit-btn-area">
